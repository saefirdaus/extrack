      ...
      <div className="w-full max-w-md space-y-6">
        <header className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-500">
            Mulai catat dan kelola keuangan pribadimu.
          </p>
        </header>
          ...
          <form action={formAction} className="space-y-5">
            <div>
              ...
              <input
                ...
                className={`block w-full rounded-lg border px-3 py-2 text-sm text-gray-900 placeholder-gray-400 transition focus:border-transparent focus:outline-none focus:ring-2 ${state.errors?.name ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-blue-600"}`}
              />
